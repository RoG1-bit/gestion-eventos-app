...
// CORRECCIÓN AQUÍ: Se exporta por defecto como ExploreScreen para que haga match con tu sistema unificado
    ...
    >
      <ThemedView style={styles.container}>
        <ThemedView style={styles.titleContainer}>
          <ThemedText type="subtitle">Explore Events</ThemedText>
          <ThemedText style={styles.centerText} themeColor="textSecondary">
            ¡Código unificado y funcionando con éxito!
          </ThemedText>
