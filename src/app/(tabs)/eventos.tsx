      ...
      <ScrollView style={styles.contenedor} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.detalleContainer}>
          ...
          <View style={styles.metaInfo}>
            <Text style={styles.metaTexto}>📅 Fecha: {eventoSeleccionado.fecha}</Text>
            <Text style={styles.metaTexto}>⏰ Hora: {eventoSeleccionado.hora || "N/A"}</Text>
            <Text style={styles.metaTexto}>📍 Lugar: {eventoSeleccionado.lugar}</Text>
          </View>

          <Text style={styles.labelDesc}>Descripción:</Text>
          <Text style={styles.descripcionTexto}>{eventoSeleccionado.descripcion}</Text>
    ...
    return (
      <ScrollView style={styles.contenedor} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formulario}>
          ...
          <TouchableOpacity
            style={[styles.boton, styles.botonGuardar, guardando && { opacity: 0.6 }]}
